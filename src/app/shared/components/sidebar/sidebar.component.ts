    ...
    <aside class="w-64 bg-primary-900 text-white min-h-screen fixed left-0 top-0 z-40 transition-transform duration-300 ease-in-out"
      ...
      <div class="p-6 border-b border-primary-800">
        <h2 class="text-xl font-bold">
          <span class="text-primary-400">Notes</span>Richy48
        </h2>
      </div>
      ...
      <nav class="mt-10">
        <ul class="space-y-2 px-4">
          <li *ngFor="let item of menuItems; trackBy: trackByFn">
            <a [routerLink]="item.route" routerLinkActive="bg-primary-500 border-r-4 border-primary-300" class="flex items-center px-4 py-3 text-white hover:bg-primary-700 hover:text-primary-200 rounded-lg transition-colors duration-200 font-medium">
